...
- Falun event price exclusion: 20 February–9 March 2027 inclusive. Existing base prices retained: 9,000 SEK on 20–23 February; 12,900 SEK on 24–26 February and 3–9 March; 14,500 SEK on 27 February–2 March.
- Mixed stays apply the discount only to eligible nights. Checkout is not charged.

Edit pricing-data.js to update owner-set prices. Monthly array index 0 is day 1. Prices are not automatically synchronized with Airbnb. Availability is maintained separately; a known price does not imply availability. Outside the supported range, request a quote. Final price is confirmed before booking.
